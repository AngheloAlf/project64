...
const ASM_REGISTER CAssembler::m_Registers[] =
{
    ...
    // o32 fpr abi names
    { "fv0",  0 },{ "fv0f", 1 },{ "fv1",  2 },{ "fv1f", 3 },{ "ft0",  4 },{ "ft0f", 5 },{ "ft1",  6 },{ "ft1f", 7 },
    { "ft2",  8 },{ "ft2f", 9 },{ "ft3", 10 },{ "ft3f",11 },{ "fa0", 12 },{ "fa0f",13 },{ "fa1", 14 },{ "fa1f",15 },
    { "ft4", 16 },{ "ft4f",17 },{ "ft5", 18 },{ "ft5f",19 },{ "fs0", 20 },{ "fs0f",21 },{ "fs1", 22 },{ "fs1f",23 },
    { "fs2", 24 },{ "fs2f",25 },{ "fs3", 26 },{ "fs3f",27 },{ "fs4", 28 },{ "fs4f",29 },{ "fs5", 30 },{ "fs5f",31 },
